...
/**
 * App\Queriplex\SptRoleQueriplex
 *
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\SptRole make()
 */
class SptRoleQueriplex extends Queriplex
{
    ...
    public function filterRules()
    {
        return [
            ...
            // 'highest_classification_level' => function ($query, $value) {
            //     if ($this->getInput('show_my_role')) {
            //         return $query->where('classification_level', '<=', $value);
            //     } else {
            //         return $query->where('classification_level', '<', $value);
            //     }
            // },
